...
function getDicePrize(d1, d2) {
  ...
  if(isDouble&&d1===4) return {label:"GLAM!", prize:"Nail Extension at 999", discount:30, icon:"💅", color:E.lavender, note:"Nail Extension at 999 service", codePrefix:"GLAM"};
  if(isDouble&&d1===3) return {label:"GLOW!", prize:"20% Off Hair services", discount:20, icon:"✨", color:E.mint, note:"20% off hair service", codePrefix:"GLOW"};
  ...
  if(sum>=11) return {label:"FRESH!", prize:"20% Off Hair services", discount:20, icon:"✂️", color:E.sky, note:"20% off hair service", codePrefix:"FRSH"};
    ...
    <Bg>
      ...
      {!done && (
        <Card>
          ...
          {[["🎰","Double 6","Bill FREE"],["🌸","Double 5","50% Off"],["💅","Double 4","Nail Ext at 999"],["✨","Double 3","20% Off Hair services"],["🐣","Double 2","Free Nail Art"],["🍀","Double 1","Rs.200 Off"],["✂️","Sum 11+","20% Off Haircut"],["🌷","Sum 9-10","15% Off"],["🐰","Sum 7-8","10% Off"],["🌼","Sum 5-6","Rs.150 Off"],["💆","Sum 2-4","Free Head Massage"]].map(([icon,combo,p])=>(
